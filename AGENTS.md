...
4. **Make code readable.** Clear names, short control flow, explicit error handling, narrow responsibilities; comments only where intent isn't obvious. Avoid clever compactness, hidden side effects, unnecessary indirection, dense nesting.
